...
#pragma warning(pop)
	...
	public:
		...
		{
			orientation = sol::GlobalRotateX(rads, orientation);
		}

		inline void GlobalRotateY(const real32& rads)
		{
			orientation = sol::GlobalRotateY(rads, orientation);
		}

		inline void GlobalRotateZ(const real32& rads)
		{
			orientation = sol::GlobalRotateZ(rads, orientation);
		}

		inline void LocalRotateX(const real32& rads)
		{
			orientation = sol::LocalRotateX(rads, orientation);
		}

		inline void LocalRotateY(const real32& rads)
		{
			orientation = sol::LocalRotateY(rads, orientation);
		}

		inline void LocalRotateZ(const real32& rads)
		{
			orientation = sol::LocalRotateZ(rads, orientation);
		}
		...
		{
			Mat4f result = sol::CalculateTransformMatrix(this->position, this->scale, this->orientation);
