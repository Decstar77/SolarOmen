...
namespace cm
{
	...
	//			uint32 w = ws->clientWidth;
	//			uint32 h = ws->clientWidth;
	//			while (w > 1 || h > 1)
	//			{
	//				w = DispatchSize(16, w);
	//				h = DispatchSize(16, h);
	...
	//	{
	//		RenderState* rs = GameMemory::PushPermanentStruct<RenderState>();
	...
	//	}
	//
	//	void Renderer::Shutdown(RenderState* rs)
	//	{
	//		// @TODO: Textures
	//		// @TODO: Shaders
	//		// @TODO: Const buffers
	...
	//	}
	//
	//	void Renderer::RenderGame(RenderState* rs, AssetState* as, EntityRenderGroup* renderGroup, PlatformState* ws, Input* input)
	//	{
	...
	//		}
	//
	//		SetViewport(rs, (real32)ws->clientWidth, (real32)ws->clientHeight);
	//
	//
	...
	//	}
	//
	//	void Renderer::PresentFrame(RenderState* rs, bool32 vsync)
	//	{
